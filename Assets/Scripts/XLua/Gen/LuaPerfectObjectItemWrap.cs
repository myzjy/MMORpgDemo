    ...
    public class LuaPerfectObjectItemWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaPerfect.ObjectItem __cl_gen_ret = new LuaPerfect.ObjectItem();
        ...
        static int _m_GetChildCount(RealStatePtr L)
        {
		    try {
                ...
                LuaPerfect.ObjectItem __cl_gen_to_be_invoked = (LuaPerfect.ObjectItem)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetChildCount(  );
		    ...
		    try {
                ...
                
                {
                    int i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string __cl_gen_ret = __cl_gen_to_be_invoked.GetChildName( i );
        ...
        static int _m_SetValue(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetValue( value );
        ...
        static int _m_GetValue(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        string __cl_gen_ret = __cl_gen_to_be_invoked.GetValue(  );
                        LuaAPI.lua_pushstring(L, __cl_gen_ret);
        ...
        static int _m_AddChild(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddChild( name, obj );
		    ...
		    try {
                ...
                
                {
                    int i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        LuaPerfect.ObjectRef __cl_gen_ret = __cl_gen_to_be_invoked.GetChildObject( i );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    string name = LuaAPI.lua_tostring(L, 2);
                        ...
                        LuaPerfect.ObjectRef __cl_gen_ret = __cl_gen_to_be_invoked.GetChildObjectByName( name );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_StaticGetChildCount_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    LuaPerfect.ObjectItem objectItem = (LuaPerfect.ObjectItem)translator.GetObject(L, 1, typeof(LuaPerfect.ObjectItem));
                    
                        int __cl_gen_ret = LuaPerfect.ObjectItem.StaticGetChildCount( objectItem );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    LuaPerfect.ObjectItem objectItem = (LuaPerfect.ObjectItem)translator.GetObject(L, 1, typeof(LuaPerfect.ObjectItem));
                        ...
                        string __cl_gen_ret = LuaPerfect.ObjectItem.StaticGetValue( objectItem );
                        LuaAPI.lua_pushstring(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string __cl_gen_ret = LuaPerfect.ObjectItem.StaticGetChildName( objectItem, i );
                        LuaAPI.lua_pushstring(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        LuaPerfect.ObjectRef __cl_gen_ret = LuaPerfect.ObjectItem.StaticGetChildObject( objectItem, i );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string name = LuaAPI.lua_tostring(L, 2);
                        ...
                        LuaPerfect.ObjectRef __cl_gen_ret = LuaPerfect.ObjectItem.StaticGetChildObjectByName( objectItem, name );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _g_get_childObjectRefList(RealStatePtr L)
        {
		    try {
                ...
                LuaPerfect.ObjectItem __cl_gen_to_be_invoked = (LuaPerfect.ObjectItem)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.childObjectRefList);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_childObjectRefList(RealStatePtr L)
        {
		    try {
                ...
                LuaPerfect.ObjectItem __cl_gen_to_be_invoked = (LuaPerfect.ObjectItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.childObjectRefList = (System.Collections.Generic.List<LuaPerfect.ObjectRef>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<LuaPerfect.ObjectRef>));
