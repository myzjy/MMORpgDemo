    ...
    public class UnityEngineCanvasWrap 
    {
        ...
        static int _g_get_renderMode(RealStatePtr L)
        {
		    try {
                ...
                translator.PushUnityEngineRenderMode(L, __cl_gen_to_be_invoked.renderMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_renderingDisplaySize(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Canvas __cl_gen_to_be_invoked = (UnityEngine.Canvas)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.renderingDisplaySize);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _e_preWillRenderCanvases(RealStatePtr L)
        {
		    try {
				...
				if (__gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.Canvas.preWillRenderCanvases += __gen_delegate;
					return 0;
				} 
