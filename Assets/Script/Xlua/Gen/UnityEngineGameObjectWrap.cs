    ...
    public class UnityEngineGameObjectWrap 
    {
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Component component;
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.TryGetComponent( type, out component );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
                    translator.Push(L, component);
        ...
        static int _g_get_sceneCullingMask(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.GameObject __cl_gen_to_be_invoked = (UnityEngine.GameObject)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushuint64(L, __cl_gen_to_be_invoked.sceneCullingMask);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
