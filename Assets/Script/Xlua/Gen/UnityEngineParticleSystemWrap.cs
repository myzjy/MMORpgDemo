    ...
    public class UnityEngineParticleSystemWrap 
    {
        ...
        static int _m_SetParticles(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.SetParticles( particles, size, offset );
		    ...
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int size = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetParticles( particles, size );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int offset = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetParticles( particles, size, offset );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
        ...
        static int _m_GetPlaybackState(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.ParticleSystem.PlaybackState __cl_gen_ret = __cl_gen_to_be_invoked.GetPlaybackState(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_SetPlaybackState(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystem.PlaybackState playbackState;translator.Get(L, 2, out playbackState);
                    
                    __cl_gen_to_be_invoked.SetPlaybackState( playbackState );
        ...
        static int _m_GetTrails(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.ParticleSystem.Trails __cl_gen_ret = __cl_gen_to_be_invoked.GetTrails(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_SetTrails(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystem.Trails trailData;translator.Get(L, 2, out trailData);
                    
                    __cl_gen_to_be_invoked.SetTrails( trailData );
        ...
        static int _m_SetMaximumPreMappedBufferCounts_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    int vertexBuffersCount = LuaAPI.xlua_tointeger(L, 1);
                    int indexBuffersCount = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _g_get_proceduralSimulationSupported(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem __cl_gen_to_be_invoked = (UnityEngine.ParticleSystem)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.proceduralSimulationSupported);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
