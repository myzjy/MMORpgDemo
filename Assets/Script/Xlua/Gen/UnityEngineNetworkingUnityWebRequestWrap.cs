    ...
    public class UnityEngineNetworkingUnityWebRequestWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
					System.Uri uri = (System.Uri)translator.GetObject(L, 2, typeof(System.Uri));
					
					UnityEngine.Networking.UnityWebRequest __cl_gen_ret = new UnityEngine.Networking.UnityWebRequest(uri);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Uri>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					UnityEngine.Networking.UnityWebRequest __cl_gen_ret = new UnityEngine.Networking.UnityWebRequest(uri, method);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 5 && translator.Assignable<System.Uri>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && translator.Assignable<UnityEngine.Networking.DownloadHandler>(L, 4) && translator.Assignable<UnityEngine.Networking.UploadHandler>(L, 5))
				{
					...
					UnityEngine.Networking.UnityWebRequest __cl_gen_ret = new UnityEngine.Networking.UnityWebRequest(uri, method, downloadHandler, uploadHandler);
					translator.Push(L, __cl_gen_ret);
        ...
        static int _m_ClearCookieCache_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1&& translator.Assignable<System.Uri>(L, 1)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
        ...
        static int _m_Put_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Uri>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    byte[] bodyData = LuaAPI.lua_tobytes(L, 2);
        ...
        static int _m_Post_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Uri>(L, 1)&& translator.Assignable<UnityEngine.WWWForm>(L, 2)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    UnityEngine.WWWForm formData = (UnityEngine.WWWForm)translator.GetObject(L, 2, typeof(UnityEngine.WWWForm));
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Uri>(L, 1)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>>(L, 2)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection> multipartFormSections = (System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>));
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Uri>(L, 1)&& translator.Assignable<System.Collections.Generic.Dictionary<string, string>>(L, 2)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    System.Collections.Generic.Dictionary<string, string> formFields = (System.Collections.Generic.Dictionary<string, string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<string, string>));
                ...
                if(__gen_param_count == 3&& translator.Assignable<System.Uri>(L, 1)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    System.Uri uri = (System.Uri)translator.GetObject(L, 1, typeof(System.Uri));
                    System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection> multipartFormSections = (System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.Networking.IMultipartFormSection>));
                    byte[] boundary = LuaAPI.lua_tobytes(L, 3);
        ...
        static int _g_get_disposeCertificateHandlerOnDispose(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.disposeCertificateHandlerOnDispose);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_uri(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.uri);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_certificateHandler(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.certificateHandler);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_disposeCertificateHandlerOnDispose(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.disposeCertificateHandlerOnDispose = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_uri(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.uri = (System.Uri)translator.GetObject(L, 2, typeof(System.Uri));
        ...
        static int _s_set_certificateHandler(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Networking.UnityWebRequest __cl_gen_to_be_invoked = (UnityEngine.Networking.UnityWebRequest)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.certificateHandler = (UnityEngine.Networking.CertificateHandler)translator.GetObject(L, 2, typeof(UnityEngine.Networking.CertificateHandler));
