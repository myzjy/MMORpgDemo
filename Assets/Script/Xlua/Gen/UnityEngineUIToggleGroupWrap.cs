    ...
    public class UnityEngineUIToggleGroupWrap 
    {
        ...
        static int _m_NotifyToggleOn(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.UI.Toggle>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.UI.Toggle toggle = (UnityEngine.UI.Toggle)translator.GetObject(L, 2, typeof(UnityEngine.UI.Toggle));
                    bool sendCallback = LuaAPI.lua_toboolean(L, 3);
                    
                    __cl_gen_to_be_invoked.NotifyToggleOn( toggle, sendCallback );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.UI.Toggle>(L, 2)) 
                {
                    UnityEngine.UI.Toggle toggle = (UnityEngine.UI.Toggle)translator.GetObject(L, 2, typeof(UnityEngine.UI.Toggle));
        ...
        static int _m_EnsureValidState(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.EnsureValidState(  );
        ...
        static int _m_SetAllTogglesOff(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool sendCallback = LuaAPI.lua_toboolean(L, 2);
                    
                    __cl_gen_to_be_invoked.SetAllTogglesOff( sendCallback );
