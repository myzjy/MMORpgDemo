    ...
    public class UnityEngineRendererWrap 
    {
        ...
        static int _g_get_forceRenderingOff(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.forceRenderingOff);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_rendererPriority(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.rendererPriority);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_rayTracingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.rayTracingMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_forceRenderingOff(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.forceRenderingOff = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_rendererPriority(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.rendererPriority = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_rayTracingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                UnityEngine.Experimental.Rendering.RayTracingMode __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.rayTracingMode = __cl_gen_value;
