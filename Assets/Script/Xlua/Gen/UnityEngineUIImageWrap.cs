    ...
    public class UnityEngineUIImageWrap 
    {
        ...
        static int _m_DisableSpriteOptimizations(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.DisableSpriteOptimizations(  );
        ...
        static int _g_get_useSpriteMesh(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Image __cl_gen_to_be_invoked = (UnityEngine.UI.Image)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.useSpriteMesh);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_pixelsPerUnitMultiplier(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Image __cl_gen_to_be_invoked = (UnityEngine.UI.Image)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.pixelsPerUnitMultiplier);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_useSpriteMesh(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Image __cl_gen_to_be_invoked = (UnityEngine.UI.Image)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.useSpriteMesh = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_pixelsPerUnitMultiplier(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Image __cl_gen_to_be_invoked = (UnityEngine.UI.Image)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.pixelsPerUnitMultiplier = (float)LuaAPI.lua_tonumber(L, 2);
