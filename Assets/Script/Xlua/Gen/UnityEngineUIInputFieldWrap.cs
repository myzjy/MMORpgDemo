    ...
    public class UnityEngineUIInputFieldWrap 
    {
        ...
        static int _m_SetTextWithoutNotify(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetTextWithoutNotify( input );
        ...
        static int _g_get_shouldActivateOnSelect(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.shouldActivateOnSelect);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_shouldActivateOnSelect(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.shouldActivateOnSelect = LuaAPI.lua_toboolean(L, 2);
