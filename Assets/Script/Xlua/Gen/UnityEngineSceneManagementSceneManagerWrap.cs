    ...
    public class UnityEngineSceneManagementSceneManagerWrap 
    {
        ...
        static int _m_CreateScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.CreateSceneParameters>(L, 2)) 
                {
                    string sceneName = LuaAPI.lua_tostring(L, 1);
                    UnityEngine.SceneManagement.CreateSceneParameters parameters;translator.Get(L, 2, out parameters);
                    
                        UnityEngine.SceneManagement.Scene __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.CreateScene( sceneName, parameters );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_LoadScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    int sceneBuildIndex = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.SceneManagement.LoadSceneParameters parameters;translator.Get(L, 2, out parameters);
                    
                        UnityEngine.SceneManagement.Scene __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.LoadScene( sceneBuildIndex, parameters );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    string sceneName = LuaAPI.lua_tostring(L, 1);
                    UnityEngine.SceneManagement.LoadSceneParameters parameters;translator.Get(L, 2, out parameters);
                    
                        UnityEngine.SceneManagement.Scene __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.LoadScene( sceneName, parameters );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters parameters;translator.Get(L, 2, out parameters);
                        ...
                        UnityEngine.AsyncOperation __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( sceneBuildIndex, parameters );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters parameters;translator.Get(L, 2, out parameters);
                        ...
                        UnityEngine.AsyncOperation __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( sceneName, parameters );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_UnloadSceneAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.UnloadSceneOptions>(L, 2)) 
                {
                    int sceneBuildIndex = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.SceneManagement.UnloadSceneOptions options;translator.Get(L, 2, out options);
                    
                        UnityEngine.AsyncOperation __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync( sceneBuildIndex, options );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.UnloadSceneOptions>(L, 2)) 
                {
                    string sceneName = LuaAPI.lua_tostring(L, 1);
                    UnityEngine.SceneManagement.UnloadSceneOptions options;translator.Get(L, 2, out options);
                    
                        UnityEngine.AsyncOperation __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync( sceneName, options );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.SceneManagement.Scene>(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.UnloadSceneOptions>(L, 2)) 
                {
                    UnityEngine.SceneManagement.Scene scene;translator.Get(L, 1, out scene);
                    UnityEngine.SceneManagement.UnloadSceneOptions options;translator.Get(L, 2, out options);
                    
                        UnityEngine.AsyncOperation __cl_gen_ret = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync( scene, options );
                        translator.Push(L, __cl_gen_ret);
