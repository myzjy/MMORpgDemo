    ...
    public class UnityEngineSkinnedMeshRendererWrap 
    {
        ...
        static int _g_get_forceMatrixRecalculationPerRender(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.SkinnedMeshRenderer __cl_gen_to_be_invoked = (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.forceMatrixRecalculationPerRender);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_forceMatrixRecalculationPerRender(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.SkinnedMeshRenderer __cl_gen_to_be_invoked = (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.forceMatrixRecalculationPerRender = LuaAPI.lua_toboolean(L, 2);
