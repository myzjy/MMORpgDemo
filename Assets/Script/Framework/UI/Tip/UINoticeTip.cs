...
namespace Script.Framework.UI.Tip
{
    ...
    public class UINoticeTip : MMOSingletonDontDestroy<UINoticeTip>
    {
        ...
        private static int LastClickIndex { get; set; }
        ...
        public void ShowTwoButtonTip(string title, string content, string btnText1, string btnText2, Action callback1,
            Action callback2)
        {
            if (go == null)
            {
        ...
        public void ShowThreeButtonTip(string title, string content, string btnText1, string btnText2, string btnText3,
            Action callback1, Action callback2, Action callback3)
        {
            if (go == null)
            {
                ToolsDebug.LogError("You should set UIGameObject first!");
        ...
        public bool isDone
        {
            get { return go != null && (LastClickIndex != -1); }
        }
